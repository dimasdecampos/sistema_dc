    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-950/60 backdrop-blur-xs animate-in fade-in duration-200">
      <div className="bg-white w-full max-w-md rounded-3xl shadow-2xl border border-slate-100 overflow-hidden flex flex-col max-h-[92vh]">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-slate-500 mt-0.5">
                Acesso rápido e foto oficial do seu perfil
              </p>
            </div>
          </div>
          <button
        ...
        <div className="p-5 sm:p-6 space-y-4 overflow-y-auto">
          {/* Único Botão Padrão Google Oficial */}
          <div className="pt-2 pb-1 flex flex-col items-center">
            <button
              type="button"
              onClick={handleOfficialClick}
              disabled={isOfficialLoading}
              className="w-full h-12 px-4 bg-white hover:bg-slate-50 active:bg-slate-100 text-[#3c4043] font-medium text-sm rounded-full border border-[#dadce0] hover:border-slate-400 hover:shadow-xs shadow-2xs flex items-center justify-center gap-3 transition-all cursor-pointer disabled:opacity-60 disabled:cursor-not-allowed select-none"
            >
              {isOfficialLoading ? (
                <>
            ...
            <p className="text-[11px] text-center text-slate-500 mt-2.5">
              Conexão rápida e segura com a sua conta Google.
            </p>
          </div>
          ...
          <div className="p-3 bg-emerald-50/70 border border-emerald-100 rounded-2xl flex items-start gap-2.5 text-xs text-emerald-900">
            ...
            <p className="text-[11px] leading-relaxed">
              Ao logar com o Google, seu perfil e foto oficial são associados com segurança às suas procuras e ofertas na sua cidade.
            </p>
          </div>
