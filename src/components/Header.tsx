    ...
    <header className="sticky top-0 z-30 bg-white/95 backdrop-blur-md border-b border-slate-200/80 shadow-xs">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16 sm:h-20 gap-4">
          ...
          {/* Right Area: Modern Google Login Button & Novo Cliente Button */}
          <div className="flex items-center gap-2.5 sm:gap-3 shrink-0">
            {user ? (
              ...
              <button
                onClick={onOpenLogin}
                className="inline-flex items-center gap-2.5 px-3.5 sm:px-4 py-2 text-xs sm:text-sm font-semibold text-slate-700 bg-white hover:bg-slate-50 active:bg-slate-100 border border-slate-200/90 hover:border-slate-300 rounded-xl shadow-2xs hover:shadow-xs transition cursor-pointer"
              ...
              >
                ...
                <span className="hidden xs:inline">Entrar com o Google</span>
